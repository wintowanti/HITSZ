...
def cornersHeuristic(defstate, problem):
    """
...
class TinyMazeSearchAgent(SearchAgent):
    def __init__(self, fn='tinyMazeSearch', prob='PositionSearchProblem', heuristic='nullHeuristic'):
...
class BreathFirstSearchAgent(SearchAgent):
    def __init__(self, fn='bfs', prob='PositionSearchProblem', heuristic='nullHeuristic'):
        self.searchFunction = getattr(search,fn)
        self.searchType = globals()[prob]

class UniformCostSearchAgent(SearchAgent):
    def __init__(self, fn='ucs', prob='PositionSearchProblem', heuristic='nullHeuristic'):
        self.searchFunction = getattr(search,fn)
        self.searchType = globals()[prob]
